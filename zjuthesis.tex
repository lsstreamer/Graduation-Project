...
\documentclass[
    ...
    % Title
    Title           =  基于扩散模型的AIGC纹理生成技术,
    TitleEng        = {{AI-Driven Texture Generation via Diffusion Models for Accelerating 3D Asset Production}}
]{zjuthesis}
